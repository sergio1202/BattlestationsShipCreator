...
public class BetterImageScaler
{
     ...
     * @param hint one of the rendering hints that corresponds to RenderingHints.KEY_INTERPOLATION (e.g. RenderingHints.VALUE_INTERPOLATION_NEAREST_NEIGHBOR,
     * RenderingHints.VALUE_INTERPOLATION_BILINEAR, RenderingHints.VALUE_INTERPOLATION_BICUBIC)
     * @param progressiveBilinear if true, this method will use a multi-step scaling technique that provides higher quality than the usual one-step technique (only useful in
     * down-scaling cases, where targetWidth or targetHeight is smaller than the original dimensions)
