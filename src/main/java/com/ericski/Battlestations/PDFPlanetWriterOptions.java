...
public class PDFPlanetWriterOptions implements PDFWriterOptions
{
	private static final Logger logger = getLogger(PDFPlanetWriterOptions.class);
	...
	{
		Preferences prefs = userNodeForPackage(PDFPlanetWriterOptions.class);
